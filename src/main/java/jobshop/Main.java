...
public class Main {
    // -t 100 --solver basic TabooSolver20-2 TabooSolver200-2 TabooSolver200-20 TabooSolver2000-2 TabooSolver2000-20 TabooSolver2000-200 TabooSolver20000-20 TabooSolver20000-200 TabooSolver20000-2000 --instance ft06 ft10 ft20 la01 la02 la03 la04 la05 la06 la07 la08 la09 la10 la11 la12 la13 la14 la15 la16 la17 la18 la19 la20 la21 la22 la23 la24 la25 la26 la27 la28 la29 la30 la31 la32 la33 la34 la35 la36 la37 la38 la39 la40
    ...
    static {
        ...
        solvers.put("greedySPT", new GreedySolver(0));
        solvers.put("greedyLRPT", new GreedySolver(1));
        solvers.put("greedyEST_SPT", new GreedySolver(2));
        solvers.put("greedyEST_LRPT", new GreedySolver(3));
        solvers.put("DescentSolverSPT",new DescentSolver(0));
        solvers.put("DescentSolverLRPT",new DescentSolver(1));
        solvers.put("DescentSolverEST_SPT",new DescentSolver(2));
        solvers.put("DescentSolverEST_LRPT",new DescentSolver(3));
        solvers.put("TabooSolver20-2",new TabooSolver(20,2));
        solvers.put("TabooSolver200-2",new TabooSolver(200,2));
        solvers.put("TabooSolver200-20",new TabooSolver(200,20));
        solvers.put("TabooSolver2000-2",new TabooSolver(2000,2));
        solvers.put("TabooSolver2000-20",new TabooSolver(2000,20));
        solvers.put("TabooSolver2000-200",new TabooSolver(2000,200));
        solvers.put("TabooSolver20000-20",new TabooSolver(20000,20));
        solvers.put("TabooSolver20000-200",new TabooSolver(20000,200));
        solvers.put("TabooSolver20000-2000",new TabooSolver(20000,2000));
    ...
    public static void main(String[] args) {
        ...
        long solveTimeMs = ns.getLong("timeout");
